...
if(isset($_POST['submit'])){
    ...
    if($_POST['haslo1'] == $_POST['haslo2']){
        ...
        $archiwum = htmlspecialchars($_POST['archiwum']);
        ...
        if(mysqli_num_rows($zapytanie_sprawdz)){
            ...
            $zapytanie_dodajdobazy = $poloczenie->query("INSERT INTO dane( imie, nazwisko, login, haslo1, adres, tel, email, archiwum) VALUES ('$imie','$nazwisko','$login','$haslo','$adres','$tel','$email','$archiwum',)");
